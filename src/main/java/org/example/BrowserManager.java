...
//        boolean sauce=false;
        ...
        if (sauce)
        {
            System.out.println("running sauce");
            ...
            if (browserName.equalsIgnoreCase("Chrome"))
            {
                ...
                sauceOptions.put("username", "oauth-gajerabiren1-214d5");
                sauceOptions.put("accessKey", "da5799e2-dbe6-4a89-a5a2-d816ecd6a7fb");
                sauceOptions.put("build", "selenium-build-XQAU3");
